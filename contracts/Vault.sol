...
contract Vault is Context, Constants {
    ...
    function redeem(
        ...
        uint256 _redemptionHealthFactorLimit = IVaultFactoryConfig(factory).redemptionHealthFactorLimit();
        require(_currentHealthFactor < _redemptionHealthFactorLimit, "health-factor-above-redemption-limit");
